...
import os
import pickle
from .custom_loss import camera_fitting_loss_3d, body_fitting_loss_3d
from .prior import MaxMixturePrior
from ..constant import JOINT_MAP, AMASS_JOINT_MAP, GMM_MODEL_DIR, Part_Seg_DIR
...
class SMPLify3D():
    ...
    def __init__(self,
        ...
        if self.use_collision:
            self.part_segm_fn = Part_Seg_DIR
        ...
        if joints_category=="orig":
            self.smpl_index = full_smpl_idx
            self.corr_index = full_smpl_idx 
        elif joints_category=="AMASS":
